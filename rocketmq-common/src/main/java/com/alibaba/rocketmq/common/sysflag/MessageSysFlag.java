...
public class MessageSysFlag {
     ...
     */
    public final static int TransactionNotType = (0x0 << 2); //0000
    public final static int TransactionPreparedType = (0x1 << 2);//0100
    public final static int TransactionCommitType = (0x2 << 2);//1000
    public final static int TransactionRollbackType = (0x3 << 2);//1100
