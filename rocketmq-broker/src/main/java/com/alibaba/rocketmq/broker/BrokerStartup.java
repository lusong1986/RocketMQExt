...
public class BrokerStartup {
	...
	public static BrokerController createBrokerController(String[] args) {
		...
		System.out
				.println(">>>>>>>>>>>>>>>>>>BrokerStartUp.createBrokerController, NettySystemConfig.SocketSndbufSize:"
		...
		System.out
				.println(">>>>>>>>>>>>>>>>>>BrokerStartUp.createBrokerController, NettySystemConfig.SocketRcvbufSize:"
		...
		try {
			...
			if (commandLine.hasOption('c')) {
				...
				if (file != null) {
					...
					System.out.println("################before properties2Object, messageStoreConfig:"
							+ JSON.toJSONString(messageStoreConfig));
					MixAll.properties2Object(properties, messageStoreConfig);
					System.out.println("################after properties2Object, messageStoreConfig:"
							+ JSON.toJSONString(messageStoreConfig));
			...
			if (null != namesrvAddr) {
				try {
					...
					System.out
							.printf("The Name Server Address[%s] illegal, please set it as follows, \"127.0.0.1:9876;192.168.0.1:9876\"\n",
									namesrvAddr);
					System.exit(-3);
				}
			}
			...
			System.out.println(">>>>>>>>>>>>>>>>>>BrokerStartUp.createBrokerController, brokerConfig:"
					+ JSON.toJSONString(brokerConfig));
			System.out.println(">>>>>>>>>>>>>>>>>>BrokerStartUp.createBrokerController, nettyServerConfig:"
					+ JSON.toJSONString(nettyServerConfig));
			System.out.println(">>>>>>>>>>>>>>>>>>BrokerStartUp.createBrokerController, nettyClientConfig:"
					+ JSON.toJSONString(nettyClientConfig));
			System.out.println(">>>>>>>>>>>>>>>>>>BrokerStartUp.createBrokerController, messageStoreConfig:"
					+ JSON.toJSONString(messageStoreConfig));
