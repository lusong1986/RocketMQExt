...
public class DefaultMQPushConsumerImpl implements MQConsumerInner {
	...
	public void pullMessage(final PullRequest pullRequest) {
		...
		final SubscriptionData subscriptionData = this.rebalanceImpl.getSubscriptionInner().get(
						...
						DefaultMQPushConsumerImpl.this.executeTaskLater(new Runnable() {
							...
							public void run() {
								try {
									...
									DefaultMQPushConsumerImpl.this.rebalanceImpl.removeProcessQueue(pullRequest
											.getMessageQueue());
	...
	public ConsumerRunningInfo consumerRunningInfo() {
		...
		for (SubscriptionData sd : subSet) {
			ConsumeStatus consumeStatus = this.mQClientFactory.getConsumerStatsManager().consumeStatus(
					this.groupName(), sd.getTopic());
	...
	public Set<QueueTimeSpan> queryConsumeTimeSpan(final String topic) throws RemotingException, MQClientException,
